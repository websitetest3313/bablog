...
class Collection extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "renderEntriesCollection", () => {
      ...
      return _react.default.createElement(_EntriesCollection.default, {
    ...
    _defineProperty(this, "renderEntriesSearch", () => {
      ...
      return _react.default.createElement(_EntriesSearch.default, {
  ...
  render() {
    const _this$props2 = this.props,
          ...
          isSearchResults = _this$props2.isSearchResults,
          searchTerm = _this$props2.searchTerm;
    const newEntryUrl = collection.get('create') ? (0, _urlHelper.getNewEntryUrl)(collectionName) : '';
    return _react.default.createElement(CollectionContainer, null, _react.default.createElement(_Sidebar.default, {
      collections: collections,
      searchTerm: searchTerm
    }), _react.default.createElement(CollectionMain, null, isSearchResults ? null : _react.default.createElement(_CollectionTop.default, {
...
function mapStateToProps(state, ownProps) {
  ...
  const isSearchResults = ownProps.isSearchResults,
        match = ownProps.match;
  const _match$params = match.params,
        name = _match$params.name,
        searchTerm = _match$params.searchTerm;
