...
const RecoveredEntry = (_ref) => {
  let entry = _ref.entry,
      t = _ref.t;
  console.log(entry);
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("hr", null), _react.default.createElement("h2", null, t('ui.errorBoundary.recoveredEntry.heading')), _react.default.createElement("strong", null, t('ui.errorBoundary.recoveredEntry.warning')), _react.default.createElement(CopyButton, {
    onClick: () => (0, _copyTextToClipboard.default)(entry)
  }, t('ui.errorBoundary.recoveredEntry.copyButtonLabel')), _react.default.createElement("pre", null, _react.default.createElement("code", null, entry)));
};
...
class ErrorBoundary extends _react.default.Component {
  ...
  render() {
    ...
    const _this$props = this.props,
          showBackup = _this$props.showBackup,
          t = _this$props.t;
    ...
    return _react.default.createElement(ErrorBoundaryContainer, null, _react.default.createElement("h1", null, t('ui.errorBoundary.title')), _react.default.createElement("p", null, _react.default.createElement("span", null, t('ui.errorBoundary.details')), _react.default.createElement("a", {
      href: ISSUE_URL,
      target: "_blank",
      rel: "noopener noreferrer"
    }, t('ui.errorBoundary.reportIt'))), _react.default.createElement("hr", null), _react.default.createElement("h2", null, t('ui.errorBoundary.detailsHeading')), _react.default.createElement("p", null, errorMessage), backup && showBackup && _react.default.createElement(RecoveredEntry, {
      entry: backup,
      t: t
    }));
  }
